...
class Producto(models.Model):
    ...
    tipoEquipo = models.CharField(null=False, blank=False, max_length=1000)
    subtipoEquipo = models.CharField(null=False, blank=False, max_length=1000)
    ...
    marca = models.CharField(null=False, blank=False, max_length=1000, verbose_name="Marca")
    modelo = models.CharField(null=False, blank=False, max_length=1000, verbose_name="Modelo")
    anyoFabricacion = models.IntegerField(
        null=True, blank=True, verbose_name="Año de Fabricacion")
    sn = models.CharField(null=False, blank=False, max_length=1000, verbose_name="SN")
    nref = models.CharField(null=False, blank=False, max_length=1000, verbose_name="NREF")
    descripcion = models.CharField(null=False, blank=False, max_length=1000, verbose_name="Descripcion")
    comentarios = models.CharField(null=False, blank=False, max_length=1000, verbose_name="Comentarios")
    estado = models.CharField(null=False, blank=False, max_length=1000, verbose_name="Estado")
    ...
    otros = models.CharField(null=False, blank=False, max_length=1000, verbose_name="Otros")
    clinica = models.CharField(null=False, blank=False, max_length=1000, verbose_name="Clinica")
    ubicacion = models.CharField(null=False, blank=False, max_length=1000, verbose_name="Ubicacion")
